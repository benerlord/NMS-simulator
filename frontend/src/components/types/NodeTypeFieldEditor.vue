...
import type { NodeTypeFieldItem, NodeTypeFieldCreate, NodeTypeFieldUpdate } from '@/api/types'
...
const emit = defineEmits<{
  create: [data: NodeTypeFieldCreate]
  update: [fieldId: number, data: NodeTypeFieldUpdate]
...
function openEdit(field: NodeTypeFieldItem) {
    ...
    >
      <a-form layout="vertical">
        <a-form-item v-if="!editingId" label="字段标识" required>
          <a-input v-model:value="formData.fieldKey" placeholder="如: ip_address" />
        </a-form-item>
        <a-form-item label="显示名称" required>
          <a-input v-model:value="formData.fieldLabel" placeholder="如: IP 地址" />
        </a-form-item>
        ...
        <a-form-item v-if="isSelect" label="选项列表">
          <a-input v-model:value="formData.options" placeholder="用逗号分隔，如: 北京,上海,广州" />
        </a-form-item>
