...
onMounted(() => {
  nodeTypeTableRef.value?.refresh()
  edgeTypeTableRef.value?.refresh()
})
</script>

<template>
  <div class="types-view">
    <a-tabs default-active-key="node-types">
      <a-tab-pane key="node-types" tab="节点类型">
        <NodeTypeTable ref="nodeTypeTableRef" />
      </a-tab-pane>
